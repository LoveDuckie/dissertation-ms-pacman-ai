...
namespace Pacman.Simulator
{
    ...
    {
        private static readonly string path = Assembly.GetExecutingAssembly().EscapedCodeBase;
        private static readonly string WorkingDir = Path.GetDirectoryName(path.Substring(path.IndexOf("///") + 3)).Replace("%23", "#").Replace("%20", " ");
        ...
        private readonly uint fastTimer;
        ...
        public static string AgentName { get => agentName; set => agentName = value; }
